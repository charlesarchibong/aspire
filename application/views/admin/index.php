...
<div class="navigation">
    ...
    <div id="logo">
        <a href="index-2.html">
            ...
            <img class="logo-dark" src="<?=base_url("assets/admin/assets/media/image/logo-dark.png")?>" alt="dark logo">
        </a>
    </div>
    <!-- end::logo -->
    ...
    <header class="navigation-header">
        <figure class="avatar avatar-state-success">
            <img src="<?=base_url("assets/admin/assets/media/image/user/josh.jpg")?>" class="rounded-circle" alt="image">
        </figure>
        <div>
            <h5>Joshua Uzor</h5>
...
<div id="main">
        ...
        <div class="header-right">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="p-4 text-center" data-backround-image="<?=base_url("assets/media/image/image1.png")?>">
                            ...
                            <ul class="list-group list-group-flush">
                                    ...
                                    <a href="#" class="list-group-item d-flex hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="<?=base_url("assets/admin/assets/media/image/user/man_avatar1.jpg")?>"
                                ...
                                <li>
                                    <a href="#"
                                       class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="<?=base_url("assets/admin/assets/media/image/user/women_avatar5.jpg")?>"
                                                     class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="#"
                                       class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="<?=base_url("assets/admin/assets/media/image/user/man_avatar3.jpg")?>"
                                                     class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="#" class="list-group-item d-flex hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="<?=base_url("assets/admin/assets/media/image/user/man_avatar2.jpg")?>"
                                                     class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="#"
                                       class="list-group-item d-flex align-items-center hide-show-toggler">
                                        <div>
                                            <figure class="avatar avatar-sm m-r-15">
                                                <img src="<?=base_url("assets/admin/assets/media/image/user/women_avatar1.jpg")?>"
                                                     class="rounded-circle" alt="user">
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
  ...
  <tbody>
   ...
   <script> $(document).ready(function (){
    ...
    <footer>
        <div class="container">
            <div>© 2020 Protable v1.0.0 Made by <a href="http://facebook.com/joshuauzor">Joshua Uzor</a></div>
            <div>
                <nav class="nav">
